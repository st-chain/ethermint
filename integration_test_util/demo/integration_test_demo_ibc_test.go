...
import (
	...
	ibcconntypes "github.com/cosmos/ibc-go/v6/modules/core/03-connection/types"
...
func (suite *DemoTestSuite) testSetupIbc() {
	...
	validateChainSetup := func(chain *integration_test_util.ChainIntegrationTestSuite) {
		...
		ibcClientsState, err := chain.ChainApp.IbcKeeper().ClientKeeper.ClientStates(chain.CurrentContext, &types.QueryClientStatesRequest{})
