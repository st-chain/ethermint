...
// ListVirtualFrontierContracts provides a mock function with given fields: ctx, in, opts
func (_m *EVMQueryClient) ListVirtualFrontierContracts(ctx context.Context, in *types.QueryVirtualFrontierContractsRequest, opts ...grpc.CallOption) (*types.QueryVirtualFrontierContractsResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for ListVirtualFrontierContracts")
	}

	var r0 *types.QueryVirtualFrontierContractsResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *types.QueryVirtualFrontierContractsRequest, ...grpc.CallOption) (*types.QueryVirtualFrontierContractsResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *types.QueryVirtualFrontierContractsRequest, ...grpc.CallOption) *types.QueryVirtualFrontierContractsResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*types.QueryVirtualFrontierContractsResponse)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *types.QueryVirtualFrontierContractsRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
...
// VirtualFrontierBankContractByDenom provides a mock function with given fields: ctx, in, opts
func (_m *EVMQueryClient) VirtualFrontierBankContractByDenom(ctx context.Context, in *types.QueryVirtualFrontierBankContractByDenomRequest, opts ...grpc.CallOption) (*types.QueryVirtualFrontierBankContractByDenomResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for VirtualFrontierBankContractByDenom")
	}

	var r0 *types.QueryVirtualFrontierBankContractByDenomResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *types.QueryVirtualFrontierBankContractByDenomRequest, ...grpc.CallOption) (*types.QueryVirtualFrontierBankContractByDenomResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *types.QueryVirtualFrontierBankContractByDenomRequest, ...grpc.CallOption) *types.QueryVirtualFrontierBankContractByDenomResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*types.QueryVirtualFrontierBankContractByDenomResponse)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *types.QueryVirtualFrontierBankContractByDenomRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
